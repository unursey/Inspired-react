			...
			<Container>
				<div className={s.container}>
					...
					<div className={s.contacts}>
						...
						<a className={s.link} href='tel:89990031500'>8 999 003 15 00</a>
					</div>
					...
					<div className={s.development}>
						<ul className={s.developmentList}>
							<li className={s.developmentItem}>Designer: <a className={s.link} href='https:/t.me/Mrshmallowww'>Anastasia Ilina</a></li>
							<li className={s.developmentItem}>Developer: <a className={s.link} href='https:/t.me/'></a></li>
						</ul>
					</div>
				</div>
			</Container>
